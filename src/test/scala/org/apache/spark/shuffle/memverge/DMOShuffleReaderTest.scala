...
class DMOShuffleReaderTest {
  ...
  private var reader: DMOShuffleReader[Int, Int] = _
  private var taskContext: TaskContext = _

  @BeforeClass
  def beforeClass(): Unit = {
    val conf = TestUtil.newBaseShuffleConf
        .set(MVFSOpts.forceSpillElements, 100)
  ...
  private def writeData(mapId: Int, data: List[(Int, Int)]) = {
    val writer = new DMOShuffleWriter[Int, Int, Int](
  ...
  def testReadMetrics(): Unit = {
    reader = new DMOShuffleReader[Int, Int](
